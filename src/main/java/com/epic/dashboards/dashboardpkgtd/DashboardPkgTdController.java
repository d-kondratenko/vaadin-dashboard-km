...
@Route(value = "pkgtd", layout = MainLayout.class)
//@RouteAlias("dashboards/pkgtd/:warehouseNr/:pageNumber") //test
@RouteAlias("pkgtd/:warehouseNr/:pageNumber") //prod
@UIScope
public class DashboardPkgTdController extends BaseController implements BeforeEnterObserver {

    private DashboardPkgTdMap dashboardPkgTdMap;
    public DashboardPkgTdController(DashboardQueryService dashboardQueryService, ProjectDevConfig projectDevConfig, DashboardQuery dashboardQuery){
        this.dashboardQuery = dashboardQuery;
        this.dashboardQueryService = dashboardQueryService;
        this.projectDevConfig = projectDevConfig;
        this.dashboardPkgTdMap = new DashboardPkgTdMap(dashboardQuery);
    ...
    public void beforeEnter(BeforeEnterEvent beforeEnterEvent) {
        ...
        this.dashboardLink = projectDevConfig.getDashboardPkgTdLink();
    ...
    private BaseDashboard getCurrentDashboardByWarehouseNrAndPageNumber(String warehouseNr, String pageNumber){
        BaseDashboard baseDashboard = dashboardPkgTdMap.getDashboardsPkgTd().get(warehouseNr+pageNumber);
